...
public class Main {
    public static void main(String[] args) {
        ...
        List<Comp> collect = comps.stream()
                .filter(comp -> comp.getYear() > 2010)
        ...
        List<Comp> collect1 = comps.stream()
                .filter(comp -> comp.getYear() > 2010 && comp.getHardDisk().getProducer() != Producer.CHINA)
                .collect(Collectors.toList());
        ...
        List<Comp> collect2 = comps.stream()
                .filter(comp -> comp.getHardDisk().getType() == Type.SSD && comp.getHardDisk().getVolume() > 500 && comp.getCpu().getType() == "Intell Core i7")
